    ...
    <div class="bg-white rounded-2xl shadow-sm p-6 mb-10 border border-gray-100">
        <form action="{{ route('event.search') }}" method="GET" class="space-y-4">
            <div class="flex flex-col md:flex-row gap-4 items-center">
                ...
                <input type="date" name="tanggal_mulai" class="border border-gray-300 rounded-lg py-3 px-4 focus:ring-2 focus:ring-blue-500">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">
                        {{ $event->tanggal_mulai ? \Carbon\Carbon::parse($event->tanggal_mulai)->format('d M Y') : 'Tanggal belum ditentukan' }},
                        {{ $event->lokasi  }}
                    </p>
                </div>
            </div>
